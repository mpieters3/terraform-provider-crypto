...
// GenerateJWKSTestCertAndKey generates a self-signed certificate and private key for JWKS testing.
// Returns the private key PEM, certificate PEM, and an additional chain certificate PEM.
// Uses ECDSA P-256 by default.
func GenerateJWKSTestCertAndKey(t *testing.T) (string, string, string) {
...
// GenerateJWKSTestRSACertAndKey generates a self-signed RSA certificate and private key for JWKS testing.
// Returns the private key PEM, certificate PEM, and an additional chain certificate PEM.
func GenerateJWKSTestRSACertAndKey(t *testing.T) (string, string, string) {
	...
	template := x509.Certificate{
		...
		Subject: pkix.Name{
			Country:      []string{"US"},
			Organization: []string{"Test Org RSA"},
	...
	chainTemplate := x509.Certificate{
		...
		Subject: pkix.Name{
			Country:      []string{"US"},
			Organization: []string{"Test RSA CA"},
